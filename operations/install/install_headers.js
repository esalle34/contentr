...
module.exports = {
    ...
    administration_header_administrator : {
        ...
        administration_element_uploads : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_uploads",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin'), 'a', '{ "innerTagElement" : "a", "id" : "uploads", "classes" : "dropdown-item" }','Files', 0,(SELECT id FROM uri WHERE root_id = 'uploads'))`,
        ...
        administration_element_route : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_dropdown_admin_route",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin'), 'dropdown', '{ "innerTagElement" : "a", "id" : "administrationMenuroute", "dropDownClassName" : "submenu dropright", "classes" : "dropdown-item" }', 'Routes', 1, (SELECT id FROM uri WHERE root_id = 'administration-route'))`,
        ...
        administration_element_route_search : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_dropdown_admin_route_search",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin_route'), 'dropdown', '{ "innerTagElement" : "a", "id" : "administrationMenuroute", "dropDownClassName" : "submenu dropright", "classes" : "dropdown-item" }','Search', 0,(SELECT id FROM uri WHERE root_id = 'administration-route'))`,
        ...
        administration_element_route_create : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_dropdown_admin_route_create",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin_route'), 'a', '{ "classes" : "dropdown-item" }', 'Create', 1, (SELECT id FROM uri WHERE root_id = 'create-route-form'))`,
        ...
        administration_element_route_edit : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_dropdown_admin_route_edit",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin_route'), 'a', '{ "classes" : "dropdown-item" }', 'Edit', 2, (SELECT id FROM uri WHERE root_id = 'edit-route-form'))`,
        ...
        administration_element_route_remove : {
            ...
            query : `INSERT INTO headers_elements (name, header_id, header_element_id, element, args, value, weight, uri_id) VALUES ("administration_dropdown_admin_route_remove",(SELECT id FROM headers WHERE name = 'header_administrator'), (SELECT id from (SELECT * FROM headers_elements) AS helems where helems.name='administration_dropdown_admin_route'), 'a', '{ "classes" : "dropdown-item" }', 'Remove', 3, (SELECT id FROM uri WHERE root_id = 'remove-route-form'))`,
