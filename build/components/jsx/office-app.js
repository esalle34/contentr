...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var formBuilder = document.getElementById("inputs-container");
  ...
  if (formBuilder != null) {
    var FormBuilder = _officeApp.officeRegistry["invokeFormBuilder"];

    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(FormBuilder, null), formBuilder);
  }
});