...
//Install - Forms
//Author - Eric Salle
var global_transaction = require('../global_transactions')(); //User
...
var create_route_form = JSON.stringify({
  method: "post",
  async: true,
  id: "create-route-form",
  key: "create-route-form",
  className: "create-route-form has-popin col-12 row justify-content-center backoffice-panel",
  enctype: "multipart/form-data",
  els: []
});
var remove_route_form = JSON.stringify({
  method: "post",
  async: true,
  id: "remove-route-form",
  key: "remove-route-form",
  className: "remove-route-form has-popin col-12 row justify-content-center backoffice-panel",
  enctype: "multipart/form-data",
  els: []
});
var edit_route_form = JSON.stringify({
  method: "post",
  async: true,
  id: "edit-route-form",
  key: "edit-route-form",
  className: "edit-route-form has-popin col-12 row justify-content-center backoffice-panel",
  enctype: "multipart/form-data",
  els: []
});
var edit_route_form_form = JSON.stringify({
  method: "post",
  async: true,
  id: "edit-route-form-form",
  key: "edit-route-form-form",
  className: "edit-route-form has-popin col-12 row justify-content-center",
  enctype: "multipart/form-data",
  els: []
}); //Uploader

var add_file_form = JSON.stringify({
  method: "post",
  async: true,
  id: "add-file-form",
  key: "add-file-form",
  className: "add-file-form has-popin col-12 row justify-content-center",
  enctype: "multipart/form-data",
  els: []
});
var add_folder_form = JSON.stringify({
  method: "post",
  async: true,
  id: "add-folder-form",
  key: "add-folder-form",
  className: "add-folder-form has-popin col-12 row justify-content-center",
  enctype: "multipart/form-data",
  els: []
}); //Header

var manage_header_form = JSON.stringify({
  method: "post",
  async: true,
  id: "manage-header-form",
  key: "manage-header-form",
  className: "manage-header-form backoffice-panel has-popin col-12 row justify-content-center",
  enctype: "multipart/form-data",
  els: []
});
var manage_header_form_form = JSON.stringify({
  method: "post",
  async: true,
  id: "manage-header-form-form",
  key: "manage-header-form-form",
...
module.exports = {
  login: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('login_form', '".concat(login_form, "', (SELECT id FROM uri WHERE root_id='login'), 0, true)"),
  ...
  register: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('register_form', '".concat(register_form, "', (SELECT id FROM uri WHERE root_id='register'), 2, true)"),
  ...
  create_route: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('create_route_form', '".concat(create_route_form, "', (SELECT id FROM uri WHERE root_id='create-route'), 3, true)"),
  ...
  remove_route: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('remove_route_form', '".concat(remove_route_form, "', (SELECT id FROM uri WHERE root_id='remove-route'), 0, true)"),
  ...
  edit_route: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('edit_route_form', '".concat(edit_route_form, "', (SELECT id FROM uri WHERE root_id='edit-route'), 0, true)"),
  ...
  edit_route_form_form: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('edit_route_form_form', '".concat(edit_route_form_form, "', (SELECT id FROM uri WHERE root_id='edit-route'), 3, true)"),
      message: "INSERTing edit_route form"
    },
    uri_container: {
  ...
  add_file: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('add_file_form', '".concat(add_file_form, "', (SELECT id FROM uri WHERE root_id='uploads-add-file'), 0, true)"),
  ...
  add_folder: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('add_folder_form', '".concat(add_folder_form, "', (SELECT id FROM uri WHERE root_id='uploads-add-folder'), 0, true)"),
  ...
  manage_header: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('manage_header_form', '".concat(manage_header_form, "', (SELECT id FROM uri WHERE root_id='manage-header-form'), 0, true)"),
  ...
  manage_header_form: {
    form: {
      ...
      query: "INSERT into forms (name, element, uri_id, number, isSystem) VALUES ('manage_header_form_form', '".concat(manage_header_form_form, "', (SELECT id FROM uri WHERE root_id='manage-header-form-form'), 0, true)"),
