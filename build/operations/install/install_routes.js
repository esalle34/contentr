...
module.exports = {
  home: {
    ...
    pages: {
      ...
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"main\", (SELECT id from callback WHERE filepath=\"/views/html/public/\" AND filename = \"homepage.html\"), (SELECT id FROM uri WHERE root_id = \"home\") , \"home\")"),
  ...
  administration_pages_form: {
    ...
    callback: {
      name: "INSERT_administration_callback",
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'pages_form')"),
      message: "INSERTing pages form administration callback"
    },
    pages: {
      name: "INSERT_administration",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = \"form_service\" AND callback = \"get_form\" AND form_name = \"pages_form\" ),(SELECT id FROM uri WHERE root_id = \"administrate_pages_form\"), \"administrate_pages_form\")"),
  ...
  users_login_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'login_form'  )"),
      message: "INSERTing login form callback"
    },
    pages: {
      name: "INSERT_login_form",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration login | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id from callback WHERE filename = 'form_service' AND callback = 'get_form' AND form_name=\"login_form\"), (SELECT id FROM uri WHERE root_id = \"login-form\"), \"login-form\")"),
  ...
  users_get_roles: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/users/', 'user_service', 'getRoles' )"),
      message: "INSERTing users roles callback"
    },
    pages: {
      name: "INSERT_users_roles",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'user_service' AND callback = 'getRoles' ), (SELECT id FROM uri WHERE root_id = \"get-roles\"), \"get-roles\")"),
  ...
  administration_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/administration/route/', 'route_service', 'administration_route' )"),
      message: "INSERTing create-route-form callback"
    },
    pages: {
      name: "INSERT_administration_route",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'route_service' AND callback = 'administration_route'), (SELECT id FROM uri WHERE root_id = \"administration-route\"), \"administration-route\")"),
  ...
  administration_create_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'create_route_form' )"),
      message: "INSERTing create-route-form callback"
    },
    pages: {
      name: "INSERT_route_create_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'get_form' AND form_name = 'create_route_form' ), (SELECT id FROM uri WHERE root_id = \"create-route-form\"), \"create-route-form\")"),
  ...
  administration_create_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'create_route_form' )"),
      message: "INSERTing create-route callback"
    },
    pages: {
      name: "INSERT_route_create_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'create_route_form' ), (SELECT id FROM uri WHERE root_id = \"create-route\"), \"create-route\")"),
  ...
  administration_edit_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'edit_route_form' )"),
  ...
  administration_edit_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'edit_route_form' )"),
      message: "INSERTing edit-route callback"
    },
    pages: {
      name: "INSERT_route_edit_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'edit_route_form' ), (SELECT id FROM uri WHERE root_id = \"edit-route\"), \"edit-route\")"),
  ...
  administration_remove_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form',  'remove_route_form' )"),
  ...
  administration_remove_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'remove_route_form' )"),
      message: "INSERTing remove-route callback"
    },
    pages: {
      name: "INSERT_route_remove_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'remove_route_form' ), (SELECT id FROM uri WHERE root_id = \"remove-route\"), \"remove-route\")"),
  ...
  administration_search_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'search_route' )"),
      message: "INSERTing search-route callback"
    },
    pages: {
      name: "INSERT_route_search_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'search_route' ), (SELECT id FROM uri WHERE root_id = \"search-route\"), \"search-route\")"),
  ...
  administration_manage_header_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'manage_header_form' )"),
  ...
  administration_manage_header: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'manage_header_form_form' )"),
      message: "INSERTing edit-header callback"
    },
    pages: {
      name: "INSERT_logout",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'manage_header_form_form'), (SELECT id FROM uri WHERE root_id = \"manage-header-form-form\"), \"manage-header-form-form\")"),
  ...
  administration_search_header: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'search_header' )"),
      message: "INSERTing search-header callback"
    },
    pages: {
      name: "INSERT_header_search_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'search_header' ), (SELECT id FROM uri WHERE root_id = \"search-header\"), \"search-header\")"),
  ...
  administration_create_form_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'create_form_form' )"),
  ...
  administration_create_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'create_form_form' )"),
      message: "INSERTing create-form callback"
    },
    pages: {
      name: "INSERT_form_create_callback",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form'  AND form_name = 'create_form_form' ), (SELECT id FROM uri WHERE root_id = \"create-form\"), \"create-form\")"),
  ...
  administration_edit_form_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'edit_form_form' )"),
  ...
  administration_edit_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'edit_form_form' )"),
      message: "INSERTing edit-form callback"
    },
    pages: {
      name: "INSERT_form_edit_callback",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form'  AND form_name = 'edit_form_form' ), (SELECT id FROM uri WHERE root_id = \"edit-form\"), \"edit-form\")"),
  ...
  administration_remove_form_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'remove_form_form' )"),
  ...
  administration_remove_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'remove-form-form' )"),
      message: "INSERTing remove-form callback"
    },
    pages: {
      name: "INSERT_form_remove_callback",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'remove_form_form' ), (SELECT id FROM uri WHERE root_id = \"remove-form\"), \"remove-form\")"),
  ...
  administration_request_form_post: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', \"request-form-post\" )"),
  ...
  uploads: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'get_upload_view')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'get_upload_view'), (SELECT id FROM uri WHERE root_id = \"uploads\"), \"uploads\")"),
  ...
  uploads_search: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'getFiles')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_search_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'getFiles'), (SELECT id FROM uri WHERE root_id = \"uploads_search\"), \"uploads_search\")"),
  ...
  uploads_add_file: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'add_file')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_add_file",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'add_file'), (SELECT id FROM uri WHERE root_id = \"uploads-add-file\"), \"uploads-add-file\")"),
  ...
  uploads_add_folder: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'add_folder')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_add_folder",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'add_folder' ), (SELECT id FROM uri WHERE root_id = \"uploads-add-folder\"), \"uploads-add-folder\")"),
  ...
  uploads_remove_file: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'remove_file')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_remove_file",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'remove_file'), (SELECT id FROM uri WHERE root_id = \"uploads-remove-file\"), \"uploads-remove-file\")"),
  ...
  uploads_init_directories: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/types/', 'upload_service', 'init_directories')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_init_directories",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'init_directories'), (SELECT id FROM uri WHERE root_id = \"uploads-init-dir\"), \"uploads-init-dir\")"),
  ...
  administration_create_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'create_content_types_form' )"),
  ...
  administration_create_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'create_content_types_form' )"),
      message: "INSERTing create-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_create_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'create_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"create-content-types\"), \"create-content-types\")"),
  ...
  administration_edit_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'edit_content_types_form' )"),
  ...
  administration_edit_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'edit_content_types_form' )"),
      message: "INSERTing edit-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_edit_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'edit_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"edit-content-types\"), \"edit-content-types\")"),
  ...
  administration_remove_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form',  'remove_content_types_form' )"),
  ...
  administration_remove_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'remove_content_types_form' )"),
      message: "INSERTing remove-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_remove_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'remove_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"remove-content-types\"), \"remove-content-types\")"),
  ...
  administration_create_content_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'create_content_form' )"),
  ...
  administration_create_content: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'create_content_form' )"),
      message: "INSERTing create-content callback"
    },
    pages: {
      name: "INSERT_content_create_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'create_content_form' ), (SELECT id FROM uri WHERE root_id = \"create-content\"), \"create-content\")"),
  ...
  administration_edit_content_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'edit_content_form' )"),
  ...
  administration_edit_content: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'edit_content_form' )"),
      message: "INSERTing edit-content callback"
    },
    pages: {
      name: "INSERT_content_edit_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'edit_content_form' ), (SELECT id FROM uri WHERE root_id = \"edit-content\"), \"edit-content\")"),
  ...
  administration_remove_content_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'get_form', 'remove_content_form' )"),
  ...
  administration_remove_content: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'remove_content_form' )"),
      message: "INSERTing remove-content callback"
    },
    pages: {
      name: "INSERT_content_remove_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name = 'remove_content_form' ), (SELECT id FROM uri WHERE root_id = \"remove-content\"), \"remove-content\")"),
  ...
  content_types_search: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'content_types_search')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_content_types_search_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name='content_types_search'), (SELECT id FROM uri WHERE root_id = \"content-types-search\"), \"content-types-search\")"),
  ...
  content_search: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validate_form', 'content_search')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_content_search_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validate_form' AND form_name='content_search'), (SELECT id FROM uri WHERE root_id = \"content-search\"), \"content-search\")"),
      message: "INSERTing /administrate/content/types/search section"
    },
    pages_permissions: {
