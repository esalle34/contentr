...
module.exports = {
  ...
  administration_create_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', 'create_route_form' )"),
      message: "INSERTing create-route-form callback"
    },
    pages: {
      name: "INSERT_route_create_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'create_route_form' ), (SELECT id FROM uri WHERE root_id = \"create-route-form\"), \"create-route-form\")"),
  ...
  administration_create_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'create_route_form' )"),
      message: "INSERTing create-route callback"
    },
    pages: {
      name: "INSERT_route_create_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'create_route_form' ), (SELECT id FROM uri WHERE root_id = \"create-route\"), \"create-route\")"),
  ...
  administration_edit_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', 'edit_route_form' )"),
      message: "INSERTing edit-route-form callback"
    },
    pages: {
      name: "INSERT_route_edit_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'edit_route_form' ), (SELECT id FROM uri WHERE root_id = \"edit-route-form\"), \"edit-route-form\")"),
  ...
  administration_edit_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'edit_route_form' )"),
      message: "INSERTing edit-route callback"
    },
    pages: {
      name: "INSERT_route_edit_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'edit_route_form' ), (SELECT id FROM uri WHERE root_id = \"edit-route\"), \"edit-route\")"),
  ...
  administration_remove_route_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm',  'remove_route_form' )"),
      message: "INSERTing remove-route-form callback"
    },
    pages: {
      name: "INSERT_route_remove_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'remove_route_form' ), (SELECT id FROM uri WHERE root_id = \"remove-route-form\"), \"remove-route-form\")"),
  ...
  administration_remove_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'remove_route_form' )"),
      message: "INSERTing remove-route callback"
    },
    pages: {
      name: "INSERT_route_remove_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'remove_route_form' ), (SELECT id FROM uri WHERE root_id = \"remove-route\"), \"remove-route\")"),
  ...
  administration_search_route: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'search_route' )"),
      message: "INSERTing search-route callback"
    },
    pages: {
      name: "INSERT_route_search_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'search_route' ), (SELECT id FROM uri WHERE root_id = \"search-route\"), \"search-route\")"),
  ...
  administration_manage_header_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', 'manage_header_form' )"),
      message: "INSERTing manage-header-form callback"
    },
    pages: {
      name: "INSERT_logout",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'manage_header_form' ), (SELECT id FROM uri WHERE root_id = \"manage-header-form\"), \"manage-header-form\")"),
  ...
  administration_manage_header: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'manage_header_form_form' )"),
      message: "INSERTing edit-header callback"
    },
    pages: {
      name: "INSERT_logout",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'manage_header_form_form'), (SELECT id FROM uri WHERE root_id = \"manage-header-form-form\"), \"manage-header-form-form\")"),
  ...
  administration_search_header: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'search_header' )"),
      message: "INSERTing search-header callback"
    },
    pages: {
      name: "INSERT_header_search_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'search_header' ), (SELECT id FROM uri WHERE root_id = \"search-header\"), \"search-header\")"),
  ...
  administration_request_form_post: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', \"request-form-post\" )"),
      message: "INSERTing request-form callback"
    },
    pages: {
      name: "INSERT_form_request_callback",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = \"request-form-post\" ), (SELECT id FROM uri WHERE root_id = \"request-form-post\"), \"request-form-post\")"),
  ...
  uploads: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'getUploadView')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'getUploadView'), (SELECT id FROM uri WHERE root_id = \"uploads\"), \"uploads\")"),
  ...
  uploads_add_file: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'addFile')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_add_file",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'addFile'), (SELECT id FROM uri WHERE root_id = \"uploads-add-file\"), \"uploads-add-file\")"),
  ...
  uploads_add_folder: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'addFolder')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_add_folder",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'addFolder' ), (SELECT id FROM uri WHERE root_id = \"uploads-add-folder\"), \"uploads-add-folder\")"),
  ...
  uploads_remove_file: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/', 'upload_service', 'removeFile')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_page_remove_file",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'removeFile'), (SELECT id FROM uri WHERE root_id = \"uploads-remove-file\"), \"uploads-remove-file\")"),
  ...
  uploads_init_directories: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/content/types/', 'upload_service', 'initDirectories')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_uploads_init_directories",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'upload_service' AND callback = 'initDirectories'), (SELECT id FROM uri WHERE root_id = \"uploads-init-dir\"), \"uploads-init-dir\")"),
  ...
  administration_create_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', 'create_content_types_form' )"),
      message: "INSERTing create-content-types-form callback"
    },
    pages: {
      name: "INSERT_content_types_create_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'create_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"create-content-types-form\"), \"create-content-types-form\")"),
  ...
  administration_create_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'create_content_types_form' )"),
      message: "INSERTing create-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_create_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'create_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"create-content-types\"), \"create-content-types\")"),
  ...
  administration_edit_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm', 'edit_content_types_form' )"),
      message: "INSERTing edit-content-types-form callback"
    },
    pages: {
      name: "INSERT_content_types_edit_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'edit_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"edit-content-types-form\"), \"edit-content-types-form\")"),
  ...
  administration_edit_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'edit_content_types_form' )"),
      message: "INSERTing edit-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_edit_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'edit_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"edit-content-types\"), \"edit-content-types\")"),
  ...
  administration_remove_content_types_form: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'getForm',  'remove_content_types_form' )"),
      message: "INSERTing remove-content-types-form callback"
    },
    pages: {
      name: "INSERT_content_types_remove_form_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"get\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'getForm' AND form_name = 'remove_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"remove-content-types-form\"), \"remove-content-types-form\")"),
  ...
  administration_remove_content_types: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'remove_content_types_form' )"),
      message: "INSERTing remove-content-types callback"
    },
    pages: {
      name: "INSERT_content_types_remove_pages",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"Administration | ".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name = 'remove_content_types_form' ), (SELECT id FROM uri WHERE root_id = \"remove-content-types\"), \"remove-content-types\")"),
  ...
  administration_edit_content: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'edit_content_form' )"),
  ...
  content_types_search: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'content_types_search')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_content_types_search_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name='content_types_search'), (SELECT id FROM uri WHERE root_id = \"content-types-search\"), \"content-types-search\")"),
  ...
  content_search: {
    ...
    callback: {
      ...
      query: "INSERT INTO callback (filepath, filename, callback, form_name) VALUES ('".concat(global_transaction.BACKEND_MODULE_DIR_SQL, "/form/', 'form_service', 'validateForm', 'content_search')"),
      message: "INSERTing uploads callback"
    },
    pages: {
      name: "INSERT_content_search_page",
      query: "INSERT INTO pages (title, method, theme, callback_id, uri_id, root_id) VALUES (\"".concat(global_transaction.DEFAULT_SITE_TITLE, "\", \"post\", \"office\", (SELECT id FROM callback WHERE filename = 'form_service' AND callback = 'validateForm' AND form_name='content_search'), (SELECT id FROM uri WHERE root_id = \"content-search\"), \"content-search\")"),
      message: "INSERTing /administrate/content/types/search section"
    },
    pages_permissions: {
